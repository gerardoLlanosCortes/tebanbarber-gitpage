...
function TimedModal({ source, alt, title, onClose, btnContent }) {
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center gap-6">
          <p className="text-center text-base text-pretty">
            Queremos informarle que hemos cambiado la dirección de nuestro local
            temporalmente por remodelaciones. La nueva ubicación es en{" "}
            <span className="font-bold">La Tenca 584, Maipú</span>. Agradecemos
            su comprensión
          </p>
          <Link to={"/ubicacion"} className="underline font-semibold">
            Ver en el Mapa
          </Link>
          <button
